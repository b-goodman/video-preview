...
var videoFrame = function (input, output, opts) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        ;
        var cmd = "ffmpeg " + (options.overwrite ? "-y" : "") + " -i " + input + " -vf scale=" + (options.scale.width || 320) + ":" + (options.scale.height || -1) + " -ss " + stringTimestamp_1.default(options.time || 0) + " -vframes 1 " + output;
