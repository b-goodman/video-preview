 ...
 */
var videoFrame = function (input, output, time) { return __awaiter(_this, void 0, void 0, function () {
    var _a, _stdout, stderr;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, exec("ffmpeg -i " + input + " -ss " + stringTimestamp_1.default(time || 0) + " -vframes 1 " + output)];
            case 1:
                _a = _b.sent(), _stdout = _a._stdout, stderr = _a.stderr;
                if (stderr) {
 ...
 * @returns filepath of generated frame.
 */
exports.videoFrameSequence = function (input, output, fps) { return __awaiter(_this, void 0, void 0, function () {
    var _a, _stdout, stderr;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, exec("ffmpeg -i " + input + " -vf fps=" + fps + " out%d.png")];
            case 1:
                _a = _b.sent(), _stdout = _a._stdout, stderr = _a.stderr;
                if (stderr) {
                    throw new Error(stderr);
