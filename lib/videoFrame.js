...
var videoFrame = function (input, output, opts) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        ;
        var cmd = "ffmpeg " + (options.overwrite ? "-y" : "") + " -i " + input + " -vf scale=" + (options.scale.width || -1) + ":" + (options.scale.height || -2) + " -ss " + stringTimestamp_1.default(options.time || 0) + " -vframes 1 " + output;
