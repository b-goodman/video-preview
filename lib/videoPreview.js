 ...
 */
var videoPreview = function (input, output, duration) { return __awaiter(_this, void 0, void 0, function () {
    var _a, stdout, stderr;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, exec("ffmpeg -ss 00:00:01 -i " + input + " -t " + stringTimestamp_1.default(duration) + " -vcodec copy -acodec copy " + output)];
            case 1:
